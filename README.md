About cargo-flamegraph-feedstock
================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cargo-flamegraph-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cargo-flamegraph-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add cargo-flamegraph
# for installing globally
pixi global install cargo-flamegraph
```
...
It is possible to list all of the versions of `cargo-flamegraph` available on your platform:
...
```
pixi search cargo-flamegraph --channel conda-forge
```
